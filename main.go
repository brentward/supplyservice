...
func main() {
	...
	router.HandleFunc("/partners/{id}", UpdatePartner).Methods("PATCH")
	...
	router.HandleFunc("/transactions/{id}", UpdateTransaction).Methods("PATCH")
	...
	router.HandleFunc("/consumers/{id}", UpdateConsumer).Methods("PATCH")
